            ...
            <div class="card mb-3 instances" >
                <div class="row g-0">
                    ...
                    <div class="card-body mt-2">
                        ...
                        <button type="button" class="btn ml-2 btn-dark text-light remote1" data-bs-toggle="modal" data-bs-target="#app" onClick={() => apply(results._id)}>
                        Apply 
                        </button>):
                        <button type="button" class="btn ml-2 btn-dark text-light remote1" onClick={() => apply(results._id)}>
                        Apply 
                        </button>}
                    ...
                    <li class="list-group-item" style={{cursor:"pointer"}}>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">{results.description}</p>
                                <div class="d-flex">
                                <p class="card-text"><small class="text-muted">Last updated {results.dateAdded}</small></p>
