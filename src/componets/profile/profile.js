...
const Profile = () => {
  ...
  useEffect(() => {
    if (Cookies.get("profile") == undefined) {
      ...
      const get = async () => {
        const res = await fetch(`https://normad-server.onrender.comprofile`, {
          method: "POST",
          headers: {
        ...
        const resu = await fetch(
          `https://normad-server.onrender.comprofileJob`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
  ...
  const applications = () => {
    ...
    const get = async () => {
      const res = await fetch(
        `https://normad-server.onrender.comgetYourApplication`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const getJobs = () => {
    ...
    const get = async () => {
      const resu = await fetch(`https://normad-server.onrender.comprofileJob`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const deleteJob = async (id) => {
    ...
    const resu = await fetch(`https://normad-server.onrender.comdeleteJob`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteApp = async (id) => {
    ...
    const resu = await fetch(`https://normad-server.onrender.comdeleteApp`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
    ...
    <div>
            ...
            <section class="bg-dark ">
              <div class="container">
                <div class="card mx-3 py-3 d-flex bg-dark text-light image-box">
                  <br />
                  <img
                    class="card-img-top img-fluid rounded-circle mb-2 align-self-center"
                  ...
                  <button
                    type="button"
                    class="btn btn-light align-self-center align-self-start mx-5 mb-3"
                    onClick={settings}
                  >
                    Settings
                  </button>
              ...
              <div className="row g-4">
                <div className="col-md-6 col-lg-6">
                  <li class="list-group-item">
                    {" "}
                    <i className="bi bi-person text-dark mx-1"></i>{" "}
                ...
                <div className="col-md-6 col-lg-6">
                  <li class="list-group-item">
                    ...
                    <a style={{ cursor: "pointer" }} href={values.twitter}>
                      {values.twitter}{" "}
                    </a>
                  </li>
                </div>
                ...
                <div className="col-md-6 col-lg-6">
                  <li class="list-group-item">
                    {" "}
                    <i className="bi bi-people text-dark mx-1"></i>{" "}
                    <strong>Portfolio: </strong>{" "}
                    <a
                      style={{ color: "blue", cursor: "pointer" }}
                      href={values.portfolio}
                    >
                      {values.portfolio}{" "}
                    </a>
                  </li>
      ...
      <ul class="nav justify-content-center mb-4 switch">
        <li class="nav-item d-flex">
          <button
            type="button"
            class="btn btn-dark align-self-center align-self-start mx-5 mb-3 px-4"
            onClick={getJobs}
          >
            My Jobs
          </button>
          <button
            type="button"
            class="btn btn-dark align-self-center align-self-start mx-5 mb-3"
      ...
      {jobs ? (
            ...
            <div class="container">
              {!condition ? (
                <ul class="list-group list-group-flush d-flex">
                  <li
                    class="list-group-item instances"
                    onClick={() => submit(jobs._id)}
                  ...
                  <div>
                    {!condition ? (
                      ...
                      <button
                        class="btn mx-3 btn-danger text-light remote1"
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <button
                            type="button"
                            class="btn btn-primary bg-light text-dark delete-btn"
        ...
        <h3 class="my-5" style={{ textAlign: "center", color: "grey" }}>
          List is empty
        </h3>
      )}
