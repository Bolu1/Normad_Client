...
const Setttings = () => {
  ...
  const submit = () => {
    ...
    const get = async () => {
      const res = await fetch(`https://normad-server.onrender.comeditProfile`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      <div class="container ">
        <div class="row g-4 d-flex justify-content-center">
          <div class="col-md-4 d-flex text-center avatar-block align-self-center justify-content-center">
            <div
              class="card mb-3 text-center d-flex text-white align-self-center"
              style={{ height: "400px", width: "294px" }}
            >
              <img
                class="card-img img-fluid align-self-center"
                src="img/diego-ph-fIq0tET6llw-unsplash.jpg"
                alt="Card image"
                style={{ height: "400px", width: "294px" }}
              />
              <div class="card-img-overlay align-self-center text-center d-flex pic-text">
                <h3 class="align-self-center text-center justify-content-center">
                  Awe
                </h3>
              </div>
            </div>
          ...
          <div class="col-md-4 d-flex text-center avatar-block justify-content-center">
            <div
              class="card mb-3 text-center d-flex text-white"
              style={{ height: "400px", width: "294px" }}
            >
              <img
                class="card-img "
        ...
        <form>
          ...
          <div class="form-group mt-5">
            <label for="exampleFormControlTextarea1">
              <strong>Twitter Profile Link</strong>
            </label>
            <textarea
              class="form-control xl"
              id="exampleFormControlTextarea1"
          ...
          <button
            type="button"
            class="btn btn-dark px-4 btn-md"
